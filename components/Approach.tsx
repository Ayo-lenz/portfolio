    ...
    <section className="w-full py-20">
      ...
      <div className="my-20 flex flex-col lg:flex-row items-center justify-center gap-4">
        <Card
          ...
          target audience, and key functionalities. we&apos;ll discuss things like site 
        ...
        <Card 
          ...
          description="Once we agree on the plan, i cue my spotify playlist and dive into coding.
  ...
  return (
    ...
    >
      ...
      <div className="relative z-20">
        ...
        translate-x-[-50%] translate-y-[-50%] group-hover/canvas-card:opacity-0 transition duration-200 w-full  
